...
# Filtering to Only a 14 Day Window
```{r}
mask_2021_filtered <- mask_2021 %>%
  dplyr::filter(date_EST <= as.Date("2021-05-13") + 14 &
           date_EST >= as.Date("2021-05-13") - 14)

comparator_2021_filtered <- comparator_2021 %>%
  dplyr::filter(date_EST <= as.Date("2021-05-13") + 14 &
           date_EST >= as.Date("2021-05-13") - 14)

mask_2020_filtered <- mask_2020 %>%
  dplyr::filter(date_EST <= as.Date("2020-04-03") + 14 &
           date_EST >= as.Date("2020-04-03") - 14)

comparator_2020_filtered <- comparator_2020 %>%
  dplyr::filter(date_EST <= as.Date("2020-04-03") + 14 &
           date_EST >= as.Date("2020-04-03") - 14)
...
2021
```{r}
mask_2021_date_sentiment_only <- mask_2021_filtered %>%
  group_by(date_EST) %>%
...
2020
```{r}
mask_2020_date_sentiment_only <- mask_2020_filtered %>%
  group_by(date_EST) %>%
  summarise(daily_sentiment = mean(sentiment_score)) %>%
  ungroup() %>%
...
2021
```{r}
comparator_2021_date_sentiment_only <- comparator_2021_filtered %>%
  group_by(date_EST) %>%
  summarise(daily_sentiment = mean(sentiment_score)) %>%
  ungroup() %>%
...
2020
```{r}
comparator_2020_date_sentiment_only <- comparator_2020_filtered %>%
  group_by(date_EST) %>%
  summarise(daily_sentiment = mean(sentiment_score)) %>%
  ungroup() %>%
...
2021
```{r}
mask_2021_date_sentiment_category_only <- mask_2021_filtered %>%
  group_by(date_EST) %>%
...
2020
```{r}
mask_2020_date_sentiment_category_only <- mask_2020_filtered %>%
  group_by(date_EST) %>%
  mutate(denominator = n()) %>%
  group_by(date_EST, sentiment_polarity) %>%
  summarise(sentiment_per_day = n(),
...
2021
```{r}
comparator_2021_date_sentiment_category_only <- comparator_2021_filtered %>%
  group_by(date_EST) %>%
  mutate(denominator = n()) %>%
  group_by(date_EST, sentiment_polarity) %>%
  summarise(sentiment_per_day = n(),
...
mask_comparator_2021_date_sentiment_category_only %>%
  ...
  labs(title = "Daily Change in Percent of Tweets Labeled as Positive, Negative, or Neutral",
       ...
       color = "Sentiment - Time Period")
setwd("/Users/catherinepollack/Documents/dispersed_volunteer_research_network/project_14/figures")
ggsave("220322_date_vadersentiment_percents_overall_withcomparator.tiff", width = 7.25, height = 4.51)

```

2020
```{r}
comparator_2020_date_sentiment_category_only <- comparator_2020_filtered %>%
  group_by(date_EST) %>%
  mutate(denominator = n()) %>%
  group_by(date_EST, sentiment_polarity) %>%
  summarise(sentiment_per_day = n(),
...
mask_comparator_2020_date_sentiment_category_only %>%
  ...
  labs(title = "Daily Change in Percent of Tweets Labeled as Positive, Negative, or Neutral",
       ...
       color = "Sentiment - Time Period")
setwd("/Users/catherinepollack/Documents/dispersed_volunteer_research_network/project_14/figures")
ggsave("220323_date_vadersentiment_percents_overall_withcomparator_2020.jpg", width = 7.25, height = 4.51)
