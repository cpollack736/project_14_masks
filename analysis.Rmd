...
ggsave("211118_date_vadersentiment_overall_2020.tiff", width = 7.25, height = 4.51)
```
...
setwd("/Volumes/LaCie/Dispersed Volunteer Research Network/Project 14/Output")
ggsave("211011_date_vadersentiment_overall_withcomparator.tiff", width = 7.25, height = 4.51)
...
masks_comparator_2020_date_sentiment_only %>%
  ...
  labs(title = "Daily Change in Compound Sentiment Score",
       ...
       color = "Data Set - Time Period")
setwd("/Users/catherinepollack/Documents/dispersed_volunteer_research_network/project_14/figures")
ggsave("211118_date_vadersentiment_overall_withcomparator_2020.tiff", width = 7.25, height = 4.51)
...
lm(daily_sentiment ~ date_EST + pre_post_indicator + time_after_counter,
   data = filter(masks_comparator_2021_date_sentiment_only,
                 data_set == "Masks")) %>%
  tidy(conf.int = TRUE) %>%
...
mask_2021_date_sentiment_category_only <- mask_2021 %>%
  ...
  mutate(sentiment_date_combo = factor(sentiment_date_combo,
                                       levels = c("Positive - Before Mask Mandate Lifted",
                                                  "Positive - After Mask Mandate Lifted",
                                                  "Neutral - Before Mask Mandate Lifted",
                                                  "Neutral - After Mask Mandate Lifted",
                                                  "Negative - Before Mask Mandate Lifted",
                                                  "Negative - After Mask Mandate Lifted")))
...
setwd("/Volumes/LaCie/Dispersed Volunteer Research Network/Project 14/Output")
ggsave("211011_date_vadersentiment_percents_overall.tiff", width = 7.25, height = 4.51)
```
...
mask_2020_date_sentiment_category_only <- mask_2020 %>%
  ...
  unite("sentiment_date_combo",
        ...
        remove = FALSE) %>%
  mutate(sentiment_date_combo = factor(sentiment_date_combo,
                                       levels = c("Positive - Before Mask Mandate Implemented",
                                                  "Positive - After Mask Mandate Implemented",
                                                  "Neutral - Before Mask Mandate Implemented",
                                                  "Neutral - After Mask Mandate Implemented",
                                                  "Negative - Before Mask Mandate Implemented",
                                                  "Negative - After Mask Mandate Implemented")))
mask_2020_date_sentiment_category_only %>%
  ...
  labs(title = "Daily Change in Percent of Tweets Labeled as Positive, Negative, or Neutral",
       ...
       color = "Sentiment - Time Period")
setwd("/Users/catherinepollack/Documents/dispersed_volunteer_research_network/project_14/figures")
ggsave("211118_date_vadersentiment_percents_overall_2020.tiff", width = 7.25, height = 4.51)
```
...
mask_comparator_2021_date_sentiment_category_only %>%
  ...
  labs(title = "Daily Change in Percent of Tweets Labeled as Positive, Negative, or Neutral",
       ...
       color = "Sentiment - Time Period")
setwd("/Volumes/LaCie/Dispersed Volunteer Research Network/Project 14/Output")
ggsave("211011_date_vadersentiment_percents_overall_withcomparator.tiff", width = 7.25, height = 4.51)
...
mask_comparator_2020_date_sentiment_category_only %>%
  ...
  labs(title = "Daily Change in Percent of Tweets Labeled as Positive, Negative, or Neutral",
       ...
       color = "Sentiment - Time Period")
setwd("/Users/catherinepollack/Documents/dispersed_volunteer_research_network/project_14/figures")
ggsave("211118_date_vadersentiment_percents_overall_withcomparator_2020.tiff", width = 7.25, height = 4.51)
...
lm(percent_sentiment_per_day ~ date_EST + pre_post_indicator + time_after_counter,
   data = filter(mask_comparator_2021_date_sentiment_category_only,
...
2021
```{r}
mask_2021_daily_count_only <- mask_2021 %>%
  group_by(date_EST) %>%
...
2020
```{r}
mask_2020_daily_count_only <- mask_2020 %>%
  group_by(date_EST) %>%
  summarise(count_per_day = n()) %>%
  mutate(before_after_indicator = case_when(
...
2021
```{r}
mask_2021_date_emotion_only <- mask_2021 %>%
...
mask_2021_date_emotion_only %>%
  ...
  labs(title = "Daily Change in Emotion",
       ...
       color = "Time Period")
setwd("/Volumes/LaCie/Dispersed Volunteer Research Network/Project 14/Output")
ggsave("211011_date_emotion_overall.tiff", width = 7.25, height = 4.51)
```

2020
```{r}
```{r}
mask_2020_date_emotion_only <- mask_2020 %>%
  select(date_EST, anger_total, anticipation_total, disgust_total, fear_total, trust_total, surprise_total, joy_total, sadness_total) %>%
  melt(id = "date_EST") %>%
  group_by(date_EST, variable) %>%
  summarise(daily_emotion = mean(value)) %>%
...
mask_2020_date_emotion_only %>%
  ...
  labs(title = "Daily Change in Emotion",
       ...
       color = "Time Period")
setwd("/Users/catherinepollack/Documents/dispersed_volunteer_research_network/project_14/figures")
ggsave("211118_date_emotion_overall_2020.tiff", width = 7.25, height = 4.51)
```

## Plotting - Average Daily Sentiment Comparator
2021
```{r}
comparator_2021_date_emotion_only <- comparator_2021 %>%
  select(date_EST, anger_total, anticipation_total, disgust_total, fear_total, trust_total, surprise_total, joy_total, sadness_total) %>%
  melt(id = "date_EST") %>%
  group_by(date_EST, variable) %>%
  summarise(daily_emotion = mean(value)) %>%
...
masks_comparator_2021_date_emotion_only %>%
  ...
  labs(title = "Daily Change in Emotion",
       ...
       color = "Data Set - Time Period")
setwd("/Volumes/LaCie/Dispersed Volunteer Research Network/Project 14/Output")
ggsave("211011_date_emotion_overall_withcomparator.tiff", width = 7.25, height = 4.51)

```

2020
```{r}
comparator_2020_date_emotion_only <- comparator_2020 %>%
  select(date_EST, anger_total, anticipation_total, disgust_total, fear_total, trust_total, surprise_total, joy_total, sadness_total) %>%
  melt(id = "date_EST") %>%
  group_by(date_EST, variable) %>%
  summarise(daily_emotion = mean(value)) %>%
...
masks_comparator_2020_date_emotion_only %>%
  ...
  labs(title = "Daily Change in Emotion",
       ...
       color = "Data Set - Time Period")
setwd("/Users/catherinepollack/Documents/dispersed_volunteer_research_network/project_14/figures")
ggsave("211118_date_emotion_overall_withcomparator_2020.tiff", width = 7.25, height = 4.51)
